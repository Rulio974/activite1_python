...
class window:
    def __init__(self):
        ...
        self.b1 = Button(self.window, text="N", height=2, width=10, bg='#737373', fg='White', borderwidth = 0).grid(sticky="W", row = 2, column = 1)
        self.b2 = Button(self.window, text="O", height=2, width=10, bg='#737373', fg='White', borderwidth = 0).grid(sticky="W", row = 2, column = 2)
        self.b3 = Button(self.window, text="S", height=2, width=10, bg='#737373', fg='White', borderwidth = 0).grid(sticky="W", row = 2, column = 3)
        self.b4 = Button(self.window, text="C", height=2, width=10, bg='#737373', fg='White', borderwidth = 0).grid(sticky="W", row = 2, column = 4)
